      ...
      <div className='flex flex-col justify-between gap-4 md:flex-row'>
        <article className='bg-[#D8E5C3] rounded-xl min-h-full px-3 py-6 flex flex-col gap-6 md:py-10 md:justify-stretch md:gap-8 md:w-5/12 dark:bg-[#3D4D22]'>
          ...
          <DetailsSummary
            ...
            description='Set aside space for wildflowers and undisturbed areas in your garden to give bees a safe place to nest and forage.'
          />
        </article>
        ...
        <article className='bg-[#D8E5C3] rounded-xl min-h-full px-3 py-6 flex flex-col gap-6 md:py-10 md:justify-stretch md:gap-8 md:w-5/12 dark:bg-[#3D4D22]'>
          ...
          <DetailsSummary
            ...
            description='Create a bee bath by filling a shallow dish with water and adding pebbles for bees to land on, offering them a safe place to rehydrate.'
          />
        </article>

        <div className='md:w-3/12 min-h-full'>
          <img
            src={beekeepersImage}
