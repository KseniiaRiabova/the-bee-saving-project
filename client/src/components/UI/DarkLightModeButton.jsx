...
export const DarkLightModeButton = () => {
  ...
  return (
    <label className='relative block w-12 h-6'>
      ...
      {/* Toggle track */}
      <span className='absolute inset-0 bg-transparent border border-primary-dark rounded-full hover:shadow-lg peer-focus-visible:outline peer-focus-visible:outline-1  duration-500 cursor-pointer'></span>
