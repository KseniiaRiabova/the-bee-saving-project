...
export const SignUpNotification = ({
  ...
  return (
    <div className='absolute top-[2%] left-1/2 -translate-x-1/2 w-[96%] p-4 space-y-2 text-center bg-brand-secondary-light/95 rounded-lg shadow-lg z-50 dark:bg-brand-secondary-dark/95'>
