...
export const UserRequest = ({showModal,setShowModal,setRequests,requests}) => {
	...
	return (
        ...
        <p>Dropdown</p>
			...
			{showModal && (
				<RequestFormModal  setRequests={setRequests} showModal={showModal} setShowModal={setShowModal} />
			)}
		</section>
	);
};
